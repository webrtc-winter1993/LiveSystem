...
const handleResults = (results:any) => {
    ...
    state.canvasCtx.drawImage(results.segmentationMask, 0, 0, state.canvasElement.width, state.canvasElement.height);
   ...
   //canvasCtx.globalCompositeOperation = 'source-in';则意味着处理分割后图像中的人体。 
    ...
    state.canvasCtx.drawImage(state.image, 0, 0, state.image.width, state.image.height, 0, 0, state.canvasElement.width, state.canvasElement.height);
